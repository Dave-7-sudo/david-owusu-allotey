          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="space-y-6">
                ...
                <a href="tel:+233536928695" className="flex items-center gap-4 rounded-2xl border border-slate-800 bg-[#13151a] p-5 transition-colors hover:border-blue-500/30"><div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-500/10 text-blue-400"><Phone className="h-5 w-5" /></div><div><p className="text-sm text-slate-500">Phone</p><p className="font-medium text-white">+233 53 692 8695</p></div></a>
              </div>
            </div>
